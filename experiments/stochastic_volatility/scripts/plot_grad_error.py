...
(STIXGeneral, sizes 11/12/13, figsize (4, 3)) and auto-publishes to the
Overleaf-synced ``figures/`` dir.
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--paper-name", type=str, default="StochVol_grad_error.pdf")
